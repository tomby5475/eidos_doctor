...
<div className="bg-crosses relative left-1/2 right-1/2 w-screen -ml-[50vw] -mr-[50vw] bg-crosses">
  <div className="flex flex-col gap-6 px-4 py-8 max-w-[393px] mx-auto w-full">
    {messages.map((message, index) => (
      <div
        key={index}
        className={`flex ${
          message.sender === "self" ? "flex-col items-end" : "items-end"
        } gap-2 w-full`}
      >
        ...
        <div
          className={`flex flex-col ${
            message.sender === "self" ? "items-start" : "items-end"
          } ${
            message.sender === "self" && index === messages.length - 1
              ? "w-[165px]"
              : "flex-1"
          }`}
        >
