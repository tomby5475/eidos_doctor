...
export const InterviewsSection = (): JSX.Element => {
  return (
    <section
      id="interview"
      className="flex flex-col items-center gap-8 px-4 py-8 relative left-1/2 right-1/2 w-screen -ml-[50vw] -mr-[50vw] bg-crosses"
    >
                  ...
                  <div className="flex items-center gap-4 w-full">
                    <p className="flex-1 font-['Inter',Helvetica] text-base leading-6">
                      <span className="font-medium text-[#2d323c]">
                        ...
                        we would be happy to prepare you for the next steps: all
                        types of interviews, presentations and case studies.
                        With this trainings you can build your confidence.{" "}
                        <br />
                        <br />
                      </span>
